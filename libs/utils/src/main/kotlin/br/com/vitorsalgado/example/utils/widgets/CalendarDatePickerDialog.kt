...
class CalendarDatePickerDialog : DialogFragment(), DatePickerDialog.OnDateSetListener {
  ...
  companion object {
    const val BUNDLE_DATE = "br.com.vitorsalgado.example.android.utils.widgets.calendardatepicker.DATE"
    const val DATE_FORMAT = "br.com.vitorsalgado.example.android.utils.widgets.calendardatepicker.DATE_FORMAT"
