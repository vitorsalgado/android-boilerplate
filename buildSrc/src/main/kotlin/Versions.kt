object Versions {
  ...
  val testSupportLibrary = "1.0.1"
  val constraintLayout = "1.1.0"

  // test dependencies
  val junit = "4.12"
  val hamcrest = "1.3"
  val testButler = "1.3.1"
  val robolectric = "3.8"
  val espresso = "3.0.1"
  val mockito = "2.15.0"
  ...
  val firebase_core = "15.0.2"
  val firebase_messaging = "15.0.2"
  val firebase_remote_config = "15.0.2"
  val gson = "2.8.2"
  val fresco = "1.8.1"
  val rxAndroid = "2.0.2"
  val rxJava = "2.1.10"
