...
public class RangeSeekBar<T extends Number> extends android.support.v7.widget.AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        mDefaultColor = ContextCompat.getColor(context, R.color.secondaryDark);
        mActiveSeekBarColor = ContextCompat.getColor(context, R.color.accent);
        mDefaultSeekBarColor = ContextCompat.getColor(context, R.color.soft_gray);

        Drawable drawable = ContextCompat.getDrawable(context, R.drawable.thumb);
        ...
        thumbWidth = mThumbImage.getWidth();
